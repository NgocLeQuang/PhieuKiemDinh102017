...
namespace PhieuKiemDinh.MyUserControl
{
    public partial class UC_FeedBack : UserControl
    {
        ...
        public void LoadChecker(string fbatchname, string idimage)
        {
            ...
            uC_DESO_FeedBack3.LoadDataChecker(deso[0]);
        }

        private void SoSanhTextBox()
        {
            changeColorUser(uC_DESO_FeedBack1.txt_TruongSo01, uC_DESO_FeedBack2.txt_TruongSo01);
            changeColorUser(uC_DESO_FeedBack1.txt_TruongSo03, uC_DESO_FeedBack2.txt_TruongSo03);
            changeColorUser(uC_DESO_FeedBack1.txt_TruongSo04, uC_DESO_FeedBack2.txt_TruongSo04);
            changeColorUser(uC_DESO_FeedBack1.txt_TruongSo05, uC_DESO_FeedBack2.txt_TruongSo05);
            changeColorUser(uC_DESO_FeedBack1.txt_TruongSo06, uC_DESO_FeedBack2.txt_TruongSo06);
            changeColorUser(uC_DESO_FeedBack1.txt_TruongSo07, uC_DESO_FeedBack2.txt_TruongSo07);
            changeColorUser(uC_DESO_FeedBack1.txt_TruongSo08_1, uC_DESO_FeedBack2.txt_TruongSo08_1);
            changeColorUser(uC_DESO_FeedBack1.txt_TruongSo08_2, uC_DESO_FeedBack2.txt_TruongSo08_2);
            changeColorUser(uC_DESO_FeedBack1.txt_TruongSo09, uC_DESO_FeedBack2.txt_TruongSo09);
            changeColorUser(uC_DESO_FeedBack1.txt_TruongSo10, uC_DESO_FeedBack2.txt_TruongSo10);
            changeColorUser(uC_DESO_FeedBack1.txt_TruongSo11, uC_DESO_FeedBack2.txt_TruongSo11);
            changeColorUser(uC_DESO_FeedBack1.txt_TruongSo12, uC_DESO_FeedBack2.txt_TruongSo12);
            changeColorUser(uC_DESO_FeedBack1.txt_TruongSo13, uC_DESO_FeedBack2.txt_TruongSo13);
            changeColorUser(uC_DESO_FeedBack1.txt_TruongSo14, uC_DESO_FeedBack2.txt_TruongSo14);
            changeColorUser(uC_DESO_FeedBack1.txt_FlagError, uC_DESO_FeedBack2.txt_FlagError);
        }
        ...
        {
            changeColorChecker(uC_DESO_FeedBack1.txt_TruongSo01, uC_DESO_FeedBack3.txt_TruongSo01);
            changeColorChecker(uC_DESO_FeedBack1.txt_TruongSo03, uC_DESO_FeedBack3.txt_TruongSo03);
            changeColorChecker(uC_DESO_FeedBack1.txt_TruongSo04, uC_DESO_FeedBack3.txt_TruongSo04);
            changeColorChecker(uC_DESO_FeedBack1.txt_TruongSo05, uC_DESO_FeedBack3.txt_TruongSo05);
            changeColorChecker(uC_DESO_FeedBack1.txt_TruongSo06, uC_DESO_FeedBack3.txt_TruongSo06);
            changeColorChecker(uC_DESO_FeedBack1.txt_TruongSo07, uC_DESO_FeedBack3.txt_TruongSo07);
            changeColorChecker(uC_DESO_FeedBack1.txt_TruongSo08_1, uC_DESO_FeedBack3.txt_TruongSo08_1);
            changeColorChecker(uC_DESO_FeedBack1.txt_TruongSo08_2, uC_DESO_FeedBack3.txt_TruongSo08_2);
            changeColorChecker(uC_DESO_FeedBack1.txt_TruongSo09, uC_DESO_FeedBack3.txt_TruongSo09);
            changeColorChecker(uC_DESO_FeedBack1.txt_TruongSo10, uC_DESO_FeedBack3.txt_TruongSo10);
            changeColorChecker(uC_DESO_FeedBack1.txt_TruongSo11, uC_DESO_FeedBack3.txt_TruongSo11);
            changeColorChecker(uC_DESO_FeedBack1.txt_TruongSo12, uC_DESO_FeedBack3.txt_TruongSo12);
            changeColorChecker(uC_DESO_FeedBack1.txt_TruongSo13, uC_DESO_FeedBack3.txt_TruongSo13);
            changeColorChecker(uC_DESO_FeedBack1.txt_TruongSo14, uC_DESO_FeedBack3.txt_TruongSo14);
            changeColorChecker(uC_DESO_FeedBack1.txt_FlagError, uC_DESO_FeedBack3.txt_FlagError);
